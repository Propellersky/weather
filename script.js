...
let graphProbabilityOfPrecipitation = document.querySelector(".graph-probability-of-precipitation")
...
function createWeatherApp() {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        function createForecastForCurrentDay(data) {
            ...
            icon.innerHTML = `<img src="https://openweathermap.org/img/wn/${data["current"]["weather"][0]["icon"]}@4x.png">`
        ...
        function hourlyForecastForCurrentDay(data) {
            for (let k = 0; k < factHour.length; k++) {
                ...
                factHour[k].innerHTML = hours.getHours() + " :" + " 00" + "<br>" + `<img src="https://openweathermap.org/img/wn/${data["hourly"][k]["weather"][0]["icon"]}@2x.png">` + "<br> " + Math.floor(data["hourly"][k]["temp"]) + "&deg";
            }
        }
        ...
        function createWeeklyWeatherForecast(data) {
            for (let i = 0; i < day.length; i++) {
                ...
                weatherIcon[i].innerHTML = `<img src="https://openweathermap.org/img/wn/${data['daily'][i]["weather"][0]["icon"]}@2x.png">`
        ...
        function triggerAdditionalDataShow(data, i, dailyForecast) {
            ...
            graphProbabilityOfPrecipitation.classList.add("hidden2")
